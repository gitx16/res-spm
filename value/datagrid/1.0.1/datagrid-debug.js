define("value/datagrid/1.0.1/datagrid-debug", [ "$-debug", "gallery/backbone/1.1.0/backbone-debug", "gallery/underscore/1.5.2/underscore-debug", "value/datasource/1.0.0/datasource-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "value/base/1.0.0/base-debug", "arale/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "arale/widget/1.1.1/widget-debug", "value/form-text/1.0.0/form-text-debug", "value/form/1.0.0/form-widget-debug", "gallery/handlebars/1.0.2/runtime-debug", "./data-grid-text-debug.handlebars", "value/form-select/1.0.0/form-select-debug", "jquery/select2/3.4.5/select2-zh-cn-debug", "./data-grid-select-debug.handlebars", "value/form-buttons/1.0.0/form-buttons-debug", "./data-grid-buttons-debug.handlebars", "value/form-radio/1.0.0/form-radio-debug", "value/form-checkbox/1.0.0/form-checkbox-debug", "./grid-item/grid-item-debug", "./grid-item/grid-item-debug.handlebars", "value/paginator/1.0.0/paginator-debug", "./data-grid-debug.handlebars" ], function(require, exports, module) {
    "use strict";
    var $ = require("$-debug");
...
define("value/datagrid/1.0.1/data-grid-text-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
...
define("value/datagrid/1.0.1/data-grid-select-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("value/datagrid/1.0.1/data-grid-buttons-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("value/datagrid/1.0.1/grid-item/grid-item-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("value/datagrid/1.0.1/data-grid-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
