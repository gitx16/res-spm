define("value/form-radio-label/1.0.0/form-radio-debug", [ "$-debug", "value/form/1.0.0/form-widget-debug", "value/base/1.0.0/base-debug", "arale/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "./radio-debug.handlebars" ], function(require, exports, module) {
    ...
    var FormRadio = FormWidget.extend({
        ...
        getValue: function() {
            ...
            var value = {};
            var val = this.$(".checked").data("value");
            if (val) {
                value[name] = val;
            }
            return value;
...
define("value/form-radio-label/1.0.0/radio-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program1(depth0, data, depth1) {
            ...
            buffer += '\n            <label class="radio-inline label-inline">\n                    <span class="label radio-label ';
            options = {
                hash: {},
                data: data
            };
            buffer += escapeExpression((stack1 = helpers.dealRadioChecked, stack1 ? stack1.call(depth0, depth0.value, depth1.checked, options) : helperMissing.call(depth0, "dealRadioChecked", depth0.value, depth1.checked, options))) + '" data-value="';
            ...
            buffer += escapeExpression(stack2) + '"><span class="span-radio">';
