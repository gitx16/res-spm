define("value/jwplayer/6.6.3896/jwplayer.html5-debug", [ "./jwplayer-debug" ], function(require, exports, module) {
    var jwplayer = require("./jwplayer-debug");
    (function(f) {
        f.html5 = {};
    ...
    (function(f) {
        ...
        var c = {}, a, d = {}, r = 0, j = f.exists, h = f.foreach, q = {}, A = !1, n = f.css = function(e, k, p) {
            ...
            h(k, function(b, a) {
                a: {
                    var c = a;
                    if ("undefined" === typeof c) a = void 0; else {
                        var k = p ? " !important" : "";
                        if (isNaN(c)) a = c.match(/png|gif|jpe?g/i) && 0 > c.indexOf("url") ? "url(" + c + ")" : c + k; else switch (b) {
                          case "z-index":
                          case "opacity":
                            a = c + k;
                            break a;
        ...
        f.transform = function(b, a) {
            var d = "-transform", c;
            a = a ? a : "";
            "string" == typeof b ? (c = {}, c["-webkit" + d] = a, c["-ms" + d] = a, c["-moz" + d] = a, 
            c["-o" + d] = a, f.css(b, c)) : (d = "Transform", c = b.style, c["webkit" + d] = a, 
            c["Moz" + d] = a, c["ms" + d] = a, c["O" + d] = a);
        };
        ...
        f.stretch = function(b, e, c, a, d, r) {
            if (e && (b || (b = g.UNIFORM), c && a && d && r)) {
                ...
                switch (b.toLowerCase()) {
                  ...
                  default:
                    j > h ? .95 < d * h / c ? (A = !0, n = "jwexactfit") : (d *= h, r *= h) : .95 < r * j / a ? (A = !0, 
                    n = "jwexactfit") : (d *= j, r *= j), A && (h = Math.ceil(100 * a / r) / 100, j = Math.ceil(100 * c / d) / 100);
                }
                q ? A ? (e.style.width = d + "px", e.style.height = r + "px", f.scale(e, j, h, (c - d) / 2 / j, (a - r) / 2 / h)) : (e.style.width = "", 
                e.style.height = "") : (e.className = e.className.replace(/\s*jw(none|exactfit|uniform|fill)/g, ""), 
                e.className += " " + n);
            }
        };
        var g = f.stretching = {
            ...
            e.onreadystatechange = function() {
                if (4 === e.readyState) if (200 === e.status) {
                    for (var d = e.responseText, r = [ {
                        begin: 0,
                        text: ""
                    } ], d = d.replace(/^\s+/, "").replace(/\s+$/, ""), j = d.split("</p>"), h = d.split("</tt:p>"), q = [], d = 0; d < j.length; d++) 0 <= j[d].indexOf("<p") && (j[d] = j[d].substr(j[d].indexOf("<p") + 2).replace(/^\s+/, "").replace(/\s+$/, ""), 
                    q.push(j[d]));
                    for (d = 0; d < h.length; d++) 0 <= h[d].indexOf("<tt:p") && (h[d] = h[d].substr(h[d].indexOf("<tt:p") + 5).replace(/^\s+/, "").replace(/\s+$/, ""), 
                    q.push(h[d]));
                    j = q;
                    for (d = 0; d < j.length; d++) {
                        ...
                        q = {};
                        try {
                            var f = h.indexOf('begin="'), h = h.substr(f + 7), f = h.indexOf('" end="');
            ...
            function a(a) {
                ...
                for (a = 0; a < c.length; a++) if ("WEBVTT" != c[a]) {
                    ...
                    try {
                        ...
                        if (p[k + 1]) {
                            j.text = p[k + 1];
                            for (k += 2; k < p.length; k++) j.text += "<br/>" + p[k];
                        }
                    } catch (f) {}
    ...
    (function(f) {
        ...
        f.captions = function(a, h) {
            ...
            function n() {
                ...
                0 != a && 0 != b && s.resize(b, Math.round(.94 * a));
            }
            function y(a) {
            ...
            function t(a) {
                0 < a ? (z = a - 1, B = a) : B = 0;
                z >= u.length || (u[z].data ? s.populate(u[z].data) : (C = a = u[z].file, g.ajax(a, y, k)), 
                l(!1));
            }
            function w() {
                var a = [];
    ...
    (function(f) {
        ...
        f.captions.renderer = function(b, e) {
            ...
            function a() {
                var a = h.clientWidth, c = Math.round(b.fontSize * Math.pow(a / 400, .6)), d = Math.round(1.4 * c);
                r(q, {
                    maxWidth: a + "px",
                    fontSize: c + "px",
                    lineHeight: d + "px",
            ...
            function d() {
                for (var a = -1, b = 0; b < j.length; b++) if (j[b].begin <= n && (b == j.length - 1 || j[b + 1].begin >= n)) {
                    a = b;
                    break;
                }
    ...
    (function(f) {
        ...
        var d = b.isMobile(), r = b.isAndroid(4) && !b.isChrome(), j = "button", h = "text", q = "slider", A = "100%", n = {
            ...
            display: t
        }, p = !1, l = !0, I = null, t = void 0, w = window, D = document;
        g.controlbar = function(f, m) {
            ...
            function v(a) {
                var c = p, e;
                a.duration == Number.POSITIVE_INFINITY || !a.duration && b.isSafari() && !d ? $.setText(H.jwGetPlaylist()[H.jwGetPlaylistIndex()].title || "Live broadcast") : (L.elapsed && (e = b.timeFormat(a.position), 
                L.elapsed.innerHTML = e, c = e.length != b.timeFormat(La).length), L.duration && (e = b.timeFormat(a.duration), 
                L.duration.innerHTML = e, c = c || e.length != b.timeFormat(ua).length), 0 < a.duration ? V(a.position / a.duration) : V(0), 
                ua = a.duration, La = a.position, $.setText());
                c && Aa();
            }
            function z() {
                var a = H.jwGetMute();
            ...
            function J(a) {
                b.foreach(Ra, function(b, c) {
                    b != a && ("cc" == b && (clearTimeout(xa), xa = t), "hd" == b && (clearTimeout(ya), 
                    ya = t), c.hide());
                });
            }
            function Z() {
            ...
            function ga(a) {
                0 <= a && a < fa.length && (H.jwSetCurrentQuality(a), clearTimeout(ya), ya = t, 
                ia.hide());
            }
            function ka(a) {
                0 <= a && a < na.length && (H.jwSetCurrentCaptions(a), clearTimeout(xa), xa = t, 
                ja.hide());
            }
            function la(a) {
                a.preventDefault();
            ...
            function qa(a) {
                if (ha) {
                    ...
                    100 < d && (d = 100);
                    a.type == b.touchEvents.DRAG_END ? (H.jwSeekDrag(p), L.timeRail.className = "jwrail jwsmooth", 
                    ha = I, Ta.time(d), va()) : (V(d), 500 < c - cb && (cb = c, Ta.time(d)));
            ...
            function X(a) {
                return function(b) {
                    0 == b.button && (L[a + "Rail"].className = "jwrail", "time" == a ? H.jwGetState() != c.IDLE && (H.jwSeekDrag(l), 
                    ha = a) : ha = a);
                };
            }
            function K(a) {
                ...
                if (ha && 0 == a.button) {
                    ...
                    "mouseup" == a.type ? ("time" == d && H.jwSeekDrag(p), L[d + "Rail"].className = "jwrail jwsmooth", 
                    ha = I, Ta[d.replace("H", "")](e)) : ("time" == ha ? V(e) : R(e), 500 < c - cb && (cb = c, 
                    Ta[ha.replace("H", "")](e)));
                    return !1;
                }
            }
            ...
            function ra(a) {
                if ((Ua = b.bounds(gb)) && 0 != Ua.width) {
                    ...
                    0 <= a && a <= Ua.width && (c.style.left = Math.round(a) + "px", Va(ua * a / Ua.width), 
                    ca = b.bounds(S));
                }
            }
            function Va(a) {
                ...
                if (d) {
                    ...
                    new b.touch(g).addEventListener(b.touchEvents.TAP, function() {
                        "cc" == j ? (xa ? (clearTimeout(xa), xa = t, c.hide()) : (xa = setTimeout(function() {
                            c.hide();
                            xa = t;
                        }, 4e3), k()), Fa.sendEvent(e.JWPLAYER_USER_ACTION)) : "hd" == j && (ya ? (clearTimeout(ya), 
                        ya = t, c.hide()) : (ya = setTimeout(function() {
                            c.hide();
                            ya = t;
            ...
            function ta(c) {
                ...
                if (Ba[c]) {
                    ...
                    if (e && 0 < e.elements.length) for (var m = 0; m < e.elements.length; m++) {
                            ...
                            switch (f.type) {
                              ...
                              case j:
                                if ("blank" != f.name) {
                                    f = f.name;
                                    s = C;
                                    if (!N(f + "Button").src || d && ("mute" == f || 0 == f.indexOf("volume")) || r && /hd|cc/.test(f)) f = I; else {
                                        var C = P(), l = P(), J = void 0, J = za, v = E(J.name);
                                ...
                                if (d && 0 == J.indexOf("volume")) C = void 0; else {
                                    ...
                                    for (var M = 0; M < G.length; M++) {
                                        ...
                                        if (ca) {
                                            ...
                                            2 == M && (la = R);
                                            2 == M && !u ? (ca = P(), ca.className = "jwprogressOverflow", ca.appendChild(R), 
                                            L[H] = ca, w.appendChild(ca)) : (L[H] = R, w.appendChild(R));
                                        }
                                    }
                                    ...
                                    d ? (u = new b.touch(w), u.addEventListener(b.touchEvents.DRAG_START, ab), u.addEventListener(b.touchEvents.DRAG, qa), 
                                    u.addEventListener(b.touchEvents.DRAG_END, qa), u.addEventListener(b.touchEvents.TAP, Oa)) : (la = z, 
                                    "volume" == la && !u && (la += "H"), w.addEventListener("mousedown", X(la), p));
                                    ...
                                    L[J] = f;
                                    f.vertical = l;
                                    "time" == J ? (sa = new g.overlay(ea + "_timetooltip", oa), Wa = new g.thumbs(ea + "_thumb"), 
                                    db = D.createElement("div"), db.className = "jwoverlaytext", Xa = D.createElement("div"), 
                                    C = Wa.element(), Xa.appendChild(C), Xa.appendChild(db), sa.setContents(Xa), gb = z, 
                                    Va(0), C = sa.element(), z.appendChild(C), L.timeSliderRail || a(F(".jwtime"), n), 
                                    L.timeSliderThumb && a(F(".jwtimeSliderThumb"), {
                                        "margin-left": N("timeSliderThumb").width / -2
                                    }), Ca(0), V(0), V(0), Ca(0)) : 0 == J.indexOf("volume") && (J = f, v = "volume" + (l ? "" : "H"), 
                                    x = l ? "vertical" : "horizontal", a(F(".jw" + v + ".jw" + x), {
                        ...
                        f && ("volume" == e.elements[m].name && f.vertical ? (Ga = new g.overlay(ea + "_volumeOverlay", oa), 
                        Ga.setContents(f)) : k.appendChild(f));
                    }
                }
            }
            function Da() {
                1 < H.jwGetPlaylist().length && (!D.querySelector("#" + H.id + " .jwplaylist") || H.jwGetFullscreen()) ? (a(F(".jwnext"), k), 
                a(F(".jwprev"), k)) : (a(F(".jwnext"), n), a(F(".jwprev"), n));
            }
            function Ha(a) {
                ca || (ca = b.bounds(S));
                a.offsetX(0);
            ...
            $.show = function(c) {
                if (!$.visible || c) clearTimeout(Pa), Pa = t, $.visible = !0, S.style.display = "inline-block", 
                Aa(), z(), S && S.querySelector(".jwalt") && (320 <= b.bounds(S.parentNode).width && !S.querySelector(".jwalt").innerHTML ? a(F(".jwhidden"), k) : a(F(".jwhidden"), n)), 
            ...
            L.hd && (ia = new g.menu("hd", ea + "_hd", oa, ga), d ? ba(ia, L.hd, da, "hd") : Ia(ia, L.hd, da, ma), 
            Ra.hd = ia);
            L.cc && (ja = new g.menu("cc", ea + "_cc", oa, ka), d ? ba(ja, L.cc, aa, "cc") : Ia(ja, L.cc, aa, Ya), 
            Ra.cc = ja);
            L.mute && L.volume && L.volume.vertical && (Ga = new g.overlay(ea + "_volumeoverlay", oa), 
            Ga.setContents(L.volume), Ia(Ga, L.mute, Z), Ra.volume = Ga);
            a(F(".jwright"), {
                right: N("capRight").width
            });
            kb && S.appendChild(kb);
    ...
    (function(f) {
        ...
        f.html5.controller = function(r, j) {
            ...
            function l() {
                w.state == e.IDLE && (u ? u = d : (z = l, w.repeat ? p() : w.item == w.playlist.length - 1 ? (s = 0, 
    ...
    (function(f) {
        ...
        f.display = function(q, A) {
            function n(c) {
                if (aa) aa(c); else if ((!a || !x.jwGetControls()) && da.sendEvent(b.JWPLAYER_DISPLAY_CLICK), 
                x.jwGetControls()) {
            ...
            function y(a, b) {
                Y.showicons && (a || b ? (J.setRotation("buffer" == a ? parseInt(Y.bufferrotation) : 0, parseInt(Y.bufferinterval)), 
                J.setIcon(a), J.setText(b)) : J.hide());
            }
            function k(a) {
                u != a ? (u && D(r, h), (u = a) ? (a = new Image(), a.addEventListener("load", I, h), 
                a.src = u) : (c("#" + m.id + " " + r, {
            ...
            function l(a) {
                ...
                if (a != Q) switch (Q = a, J && J.setRotation(0), a) {
                  case e.IDLE:
                    !F && !P && (u && !C && D(r, j), a = !0, x._model && !1 === x._model.config.displaytitle && (a = !1), 
                    y("play", z && a ? z.title : ""));
                    break;
    ...
    (function(f) {
        var g = jwplayer.utils, b = g.css, e = void 0, c = document, a = "none", d = "100%";
        f.displayicon = function(f, j, h, q) {
            ...
            function y(a, c, d, e) {
                ...
                f.src ? (d = g.extend({}, d), 0 < a.indexOf("Icon") && (G = f.width), d["background-image"] = "url(" + f.src + ")", 
                d["background-size"] = f.width + "px " + f.height + "px", d.width = f.width, b(A(c), d), 
                e = g.extend({}, e), f.overSrc && (e["background-image"] = "url(" + f.overSrc + ")"), 
                g.isMobile() || b("#" + t.id + " .jwdisplay:hover " + (c ? c : A()), e), b(A(), {
                    display: "table"
                }, !0)) : b(A(), {
                    display: "none"
                }, !0);
    ...
    (function(f) {
        ...
        f.dock = function(j, h) {
            ...
            u && (b(n(), {
                ...
                cursor: "pointer",
                border: d
            })), b(n("button:hover"), q(B)), b(n("button:active"), q(G)), b(n("button>div"), {
                opacity: l.iconalpha
            }), b(n("button:hover>div"), {
                opacity: l.iconalphaover
            }), b(n("button:active>div"), {
    ...
    (function(f) {
        ...
        f.instream = function(d, g, j, h) {
            ...
            E.load = function(j, M) {
                ...
                }) : (C = !0, D = b.extend(t, M), w = new a.item(j), F = document.createElement("div"), 
                F.id = E.id + "_instream_container", m = h.detachMedia(), u = new f.video(m), u.addGlobalListener(n), 
                u.addEventListener(e.JWPLAYER_MEDIA_META, p), u.addEventListener(e.JWPLAYER_MEDIA_COMPLETE, k), 
                u.addEventListener(e.JWPLAYER_MEDIA_BUFFER_FULL, y), u.addEventListener(e.JWPLAYER_MEDIA_ERROR, q), 
                u.addEventListener(e.JWPLAYER_PLAYER_STATE, A), u.attachMedia(), u.mute(g.mute), 
                u.volume(g.volume), P = new f.model({}, u), P.setVolume(g.volume), P.setMute(g.mute), 
                P.addEventListener(e.JWPLAYER_ERROR, q), z = g.playlist[g.item], v = g.getVideo().checkComplete() ? c.IDLE : d.jwGetState(), 
                h.checkBeforePlay() && (v = c.PLAYING, U = !1), s = m.currentTime, P.setPlaylist([ j ]), 
                O || ((v == c.BUFFERING || v == c.PLAYING) && m.pause(), G = new f.display(E), G.setAlternateClickHandler(function(a) {
                    d.jwGetControls() ? (P.state == c.PAUSED ? E.jwInstreamPlay() : E.jwInstreamPause(), 
                    a.hasControls = !0) : a.hasControls = !1;
                    l(e.JWPLAYER_INSTREAM_CLICK, a);
                }), F.appendChild(G.element()), B = new f.controlbar(E), F.appendChild(B.element()), 
                B.show(), d.jwGetControls() ? (B.show(), G.show()) : (B.hide(), G.hide()), x.setupInstream(F, B, G), 
                I(), u.load(P.playlist[0])));
            };
            ...
            E.jwStop = function() {
                "true" == D.controlbarstoppable.toString().toLowerCase() && (E.jwInstreamDestroy(), 
                d.jwStop());
            };
            E.jwSeek = function(a) {
    ...
    (function(f) {
        var g = f.utils, b = g.css, e = f.events.state, c = f.html5.logo = function(a, d) {
            ...
            if ("o" == k || "f" == k) n.link = "http://www.longtailvideo.com/jwpabout/?a=l&v=" + f.version + "&m=h&e=" + k;
            q = g.extend({}, n, d);
    ...
    (function(f) {
        var g = f.html5, b = f.utils, e = b.css, c = void 0;
    ...
    (function(f) {
        ...
        f.model = function(e, c) {
            function a(a) {
                ...
                if (0 < b.length) {
                    for (c = 0; c < b.length; c++) {
                        var g = b[c].split("->"), f = g[0], g = g[1] ? g[1] : f;
                        d[g] != a[f] && (d[g] = a[f], e = !0);
                    }
            ...
            A[b.JWPLAYER_PLAYER_STATE] = "newstate->state";
            A[b.JWPLAYER_MEDIA_BUFFER] = "bufferPercent->buffer";
    ...
    (function(f) {
        var g = f.utils, b = g.css, e = g.transitionStyle, c = "top", a = "bottom", d = "right", r = "left", j = void 0, h = document, q = {
            fontcase: j,
            fontcolor: "#ffffff",
            fontsize: 12,
            fontweight: j,
        ...
        f.html5.overlay = function(e, f, y) {
            ...
            function t(e, f) {
                ...
                f && (m[f] = h[f], m[e] = 0, n[e] = h[e], n[f] = 0, b(k("jw" + e), m), b(k("jw" + f), n), 
                G[e] = h[e], G[f] = h[f]);
            }
            function w() {
                0 != m.clientWidth && (b(k(), {
    ...
    (function(f) {
        ...
        f.playlistcomponent = function(r, j) {
            ...
            v.itemImage ? (B = (s - v.itemImage.height) / 2 + "px ", G = v.itemImage.width, 
            C = v.itemImage.height) : (G = 4 * s / 3, C = s);
            ...
            n.jwAddEventListener(b.JWPLAYER_PLAYLIST_LOADED, function() {
                ...
                if (I = d) {
                    ...
                    for (b = 0; b < I.length; b++) {
                        var h = b, d = I[h], g = q("li", "jwitem"), j = void 0;
                        g.id = t.id + "_item_" + h;
                        0 < h ? (j = q("div", "jwplaylistdivider"), g.appendChild(j)) : (h = v.divider ? v.divider.height : 0, 
                        g.style.height = s - h + "px", g.style["background-size"] = "100% " + (s - h) + "px");
                        ...
                        h.appendChild(j);
                        d.description && !z && (j = q("span", "jwdescription"), j.innerHTML = d.description, 
                        h.appendChild(j));
                        g.appendChild(h);
                        d = g;
    ...
    (function(f) {
        ...
        var b = jwplayer.utils, e = b.touchEvents, c = b.css, a = document, d = window, r = void 0;
        f.playlistslider = function(g, f, q, A) {
            ...
            function p(a) {
                if (M) return a = a ? a : d.event, aa(B - (a.detail ? -1 * a.detail : a.wheelDelta / 40) / 10), 
                a.stopPropagation && a.stopPropagation(), a.preventDefault && a.preventDefault(), 
                a.cancelBubble = !0, a.cancel = !0, a.returnValue = !1;
            }
            function l(b) {
                0 == b.button && (u = !0);
            ...
            function w(a) {
                return function(b) {
                    0 < b.button || (aa(B + .05 * a), G = setTimeout(function() {
    ...
    (function(f) {
        ...
        f.rightclick = function(a, b) {
            ...
            var h, q = g.extend({
                aboutlink: "http://www.longtailvideo.com/jwpabout/?a=r&v=" + f.version + "&m=h&e=o",
    ...
    (function(f) {
        ...
        f.skinloader = function(c, a, d) {
            ...
            function h(a) {
                ...
                if (0 === a.length) k(y); else for (c = 0; c < a.length; c++) {
            ...
            function A(a, b) {
                ...
                if (0 !== e.indexOf("data:image/png;base64,")) var f = g.getAbsolutePath(t), e = [ f.substr(0, f.lastIndexOf("/")), b, e ].join("/");
                y[b].elements[d] = {
                    height: 0,
                    width: 0,
                    src: "",
                ...
                c.onload = function() {
                    ...
                    e ? (e.height = Math.round(c.height / x * D), e.width = Math.round(c.width / x * D), 
                    e.src = c.src, e.ready = !0, q()) : g.log("Loaded an image for a missing element: " + a + "." + d);
                };
                c.onerror = function() {
                    w = !0;
                    q();
            ...
            var y = {}, k = a, p = d, l = !0, I, t = c, w = !1, D = (jwplayer.utils.isMobile(), 
            1), x = 1;
        ...
        f.thumbs = function(c) {
            ...
            this.updateTimeline = function(a) {
                ...
                if (h) {
                    ...
                    b == h.length && b--;
                    if (h[b].text) if (a = h[b].text, 0 > a.indexOf("://") && (a = q ? q + "/" + a : a), 
                    0 < a.indexOf("#xywh")) try {
                    ...
                    } else g = new Image(), g.addEventListener("load", f, !1), g.src = a;
                }
            };
    ...
    (function(f) {
        ...
        f.html5.video = function(d) {
            ...
            function q(d) {
                O && (z || (z = c, A()), "loadedmetadata" == d.type && (m.muted && (m.muted = a, 
                m.muted = c), f(b.JWPLAYER_MEDIA_META, {
                    duration: m.duration,
            ...
            var t = g.isIE(), w = {
                ...
                emptied: j,
                ended: function() {
                    O && C != e.IDLE && (J = -1, Y = c, f(b.JWPLAYER_MEDIA_BEFORECOMPLETE), O && (l(e.IDLE), 
                    Y = a, f(b.JWPLAYER_MEDIA_COMPLETE)));
                },
                error: function() {
            ...
            Q.setCurrentQuality = function(a) {
                J != a && (a = parseInt(a), 0 <= a && U && U.length > a && (J = a, g.saveCookie("qualityLabel", U[a].label), 
    ...
    (function(f) {
        ...
        f.view = function(D, x) {
            ...
            function C(a, d, e) {
                ...
                V && V.redraw();
                R && R.redraw(p);
                H && (H.offset(R && 0 <= H.position().indexOf("bottom") ? R.height() + R.margin() : 0), 
                setTimeout(function() {
            ...
            function M(a) {
                ...
                R && (W ? (R.audioMode(p), Y(), V.hidePreview(p), V && V.hide(), da(l)) : (R.audioMode(l), 
                ab(X.jwGetState())));
                H && W && H && H.hide(W);
            ...
            function E(a) {
                h || (a ? (T.className += " jwfullscreen", q.getElementsByTagName("body")[0].style["overflow-y"] = I) : (T.className = T.className.replace(/\s+jwfullscreen/, ""), 
            ...
            function ab(b) {
                ...
                switch (b) {
                  case e.PLAYING:
                    K.getVideo().audioMode() ? (da(l), V.hidePreview(W), V.setHiding(p), R && R.hideFullscreen(p)) : (da(p), 
                    F(), V.hidePreview(p), R && R.hideFullscreen(l));
                    Q();
                    break;
            ...
            this.setup = function(d) {
                if (!Ba) {
                    ...
                    K.playlistsize && K.playlistposition && K.playlistposition != t && (Ea = new f.playlistcomponent(X, {}), 
                    Ya.appendChild(Ea.element()));
                    ...
                    a || (ra.addEventListener("mouseout", function() {
                        clearTimeout(ma);
                        ma = setTimeout(Q, 10);
                    }, l), ra.addEventListener("mousemove", z, l), g.isIE() && (ta.addEventListener("mousemove", z, l), 
            ...
            var Na = this.fullscreen = function(c) {
                ...
                c ? a ? (ba.webkitEnterFullScreen(), K.setFullscreen(p)) : K.fullscreen || (E(p), 
                ...
                K.setFullscreen(p)) : (a ? (ba.webkitExitFullScreen(), K.setFullscreen(l), d && (ba.controls = p, 
                ba.controls = l)) : K.fullscreen && (E(l), K.setFullscreen(l), q.cancelFullScreen ? q.cancelFullScreen() : q.mozCancelFullScreen ? q.mozCancelFullScreen() : q.webkitCancelFullScreen && q.webkitCancelFullScreen()), 
            ...
            this.setControls = function(a) {
                ...
                }) : (Q(), V && V.hide()), Ka && (a ? (Ha.show(), Ca.show()) : (Ha.hide(), Ca.hide())), 
                fa.sendEvent(b.JWPLAYER_CONTROLS, {
                    controls: d
                }));
            };
            this.forceState = function(a) {
    ...
    (function(f) {
        ...
        f.rightclick = function(e, c) {
            if ("free" == e.edition()) c.aboutlink = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + f.version + "&m=h&e=f", 
            delete c.abouttext; else {
                if (!c.aboutlink) {
                    var a = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + f.version + "&m=h&e=", d = e.edition();
                    c.aboutlink = a + ("pro" == d ? "p" : "premium" == d ? "r" : "ads" == d ? "a" : "f");
                }
                c.abouttext ? c.abouttext = "About " + c.abouttext + " ..." : (a = e.edition(), 
                a = a.charAt(0).toUpperCase() + a.substr(1), c.abouttext = "About JW Player " + f.version + " (" + a + " edition)");
            }
            g(this, new b(e, c));
        };
    })(jwplayer.html5);
...
define("value/jwplayer/6.6.3896/jwplayer-debug", [], function(require, exports, module) {
    var jwplayer;
    jwplayer = function(d) {
        if (jwplayer.api) return jwplayer.api.selectPlayer(d);
    }, jwplayer.version = "6.6.3896", jwplayer.vid = document.createElement("video"), 
    ...
    function(d) {
        ...
        b.getAbsolutePath = function(a, e) {
            ...
            if (b.exists(a)) {
                ...
                0 === a.indexOf("/") ? j = a.split("/") : (j = e.split("?")[0], j = j.substring(c.length + g.length + 1, j.lastIndexOf("/")), 
        ...
        b.extend = function() {
            ...
            if (1 < a.length) {
                for (var e = 1; e < a.length; e++) b.foreach(a[e], function(e, g) {
                    try {
                        b.exists(g) && (a[0][e] = g);
                    } catch (c) {}
                });
        ...
        b.translateEventResponse = function(a, e) {
            ...
            delete c.message) : "object" == typeof c.data ? (c = b.extend(c, c.data), delete c.data) : "object" == typeof c.metadata && b.deepReplaceKeyName(c.metadata, [ "__dot__", "__spc__", "__dsh__", "__default__" ], [ ".", " ", "-", "default" ]);
        ...
        b.foreach = function(a, c) {
            var e, g;
            for (e in a) "function" == b.typeOf(a.hasOwnProperty) ? a.hasOwnProperty(e) && (g = a[e], 
            c(e, g)) : (g = a[e], c(e, g));
        };
        b.isHTTPS = function() {
        ...
        b.ajax = function(a, c, j) {
            ...
            if (h && b.exists(e.XDomainRequest)) g = new XDomainRequest(), g.onload = f(g, a, c, j), 
            g.onerror = k(j, a, g); else if (b.exists(e.XMLHttpRequest)) {
                var d = g = new XMLHttpRequest(), t = a;
        ...
        b.filterPlaylist = function(a, c) {
            ...
            if (c && 0 == e.length) for (g = 0; g < a.length; g++) if (j = b.extend({}, a[g]), 
            j.sources = b.filterSources(j.sources, !0), 0 < j.sources.length) {
        ...
        b.filterSources = function(a, c) {
            ...
            if (a) {
                ...
                for (var f = 0; f < a.length; f++) {
                    var h = a[f].type, n = a[f].file;
                    n && n.trim && (n = n.trim());
                    h || (h = j.extType(b.extension(n)), a[f].type = h);
                    c ? d.embed.flashCanPlay(n, h) && (e || (e = h), h == e && g.push(b.extend({}, a[f]))) : b.canPlayHTML5(h) && (e || (e = h), 
        ...
        d.scriptloader = function(f) {
            ...
            this.load = function() {
                ...
                c.addEventListener(b.COMPLETE, e); else if (d.scriptloader.loaders[f] = this, j == a.NEW) {
                    j = a.LOADING;
        ...
        d.touch = function(f) {
            function h(b) {
                b.type == k ? (c = !0, m = j(l.DRAG_START, b)) : b.type == a ? c && (p || (e(l.DRAG_START, b, m), 
                p = !0), e(l.DRAG, b)) : (c && (p ? e(l.DRAG_END, b) : (b.cancelBubble = !0, e(l.TAP, b))), 
                c = p = !1, m = null);
            }
            function e(a, b, c) {
                if (n[a] && (b.preventManipulation && b.preventManipulation(), b.preventDefault && b.preventDefault(), 
                b = c ? c : j(a, b))) n[a](b);
            }
            function j(a, c) {
                var e = null;
                ...
                if (!e) return null;
                var j = b.getBoundingClientRect(), e = {
                    type: a,
                    target: b,
        ...
        d.key = function(a) {
            ...
            try {
                ...
                var e = a.split("/");
                (k = e[0]) ? /^(free|pro|premium|ads)$/i.test(k) ? (f = e[1], e[2] && 0 < parseInt(e[2]) && (h = new Date(), 
        ...
        a.encrypt = function(h, e) {
            ...
            for (var b = a.strToLongs(f.encode(e).slice(0, 16)), c = j.length, d = j[c - 1], m = j[0], p, l = Math.floor(6 + 52 / c), g = 0; 0 < l--; ) {
                g += 2654435769;
                p = g >>> 2 & 3;
                for (var q = 0; q < c; q++) m = j[(q + 1) % c], d = (d >>> 5 ^ m << 2) + (m >>> 3 ^ d << 4) ^ (g ^ m) + (b[q & 3 ^ p] ^ d), 
                d = j[q] += d;
            }
            j = a.longsToStr(j);
            return k.encode(j);
        ...
        a.decrypt = function(h, e) {
            ...
            for (var j = a.strToLongs(k.decode(h)), b = a.strToLongs(f.encode(e).slice(0, 16)), c = j.length, d = j[c - 1], m = j[0], p, l = 2654435769 * Math.floor(6 + 52 / c); 0 != l; ) {
                p = l >>> 2 & 3;
                for (var g = c - 1; 0 <= g; g--) d = j[0 < g ? g - 1 : c - 1], d = (d >>> 5 ^ m << 2) + (m >>> 3 ^ d << 4) ^ (l ^ m) + (b[g & 3 ^ p] ^ d), 
                m = j[g] -= d;
                l -= 2654435769;
            }
            j = a.longsToStr(j);
        ...
        var k = {
            ...
            encode: function(a, e) {
                ...
                l = g.length % 3;
                if (0 < l) for (;3 > l++; ) p += "=", g += "\0";
                for (l = 0; l < g.length; l += 3) j = g.charCodeAt(l), b = g.charCodeAt(l + 1), 
                c = g.charCodeAt(l + 2), d = j << 16 | b << 8 | c, j = d >> 18 & 63, b = d >> 12 & 63, 
                c = d >> 6 & 63, d &= 63, m[l / 3] = q.charAt(j) + q.charAt(b) + q.charAt(c) + q.charAt(d);
                m = m.join("");
            ...
            decode: function(a, e) {
                ...
                l = e ? f.decode(a) : a;
                for (var q = 0; q < l.length; q += 4) j = g.indexOf(l.charAt(q)), b = g.indexOf(l.charAt(q + 1)), 
                d = g.indexOf(l.charAt(q + 2)), m = g.indexOf(l.charAt(q + 3)), c = j << 18 | b << 12 | d << 6 | m, 
                j = c >>> 16 & 255, b = c >>> 8 & 255, c &= 255, p[q / 4] = String.fromCharCode(j, b, c), 
                64 == m && (p[q / 4] = String.fromCharCode(j, b)), 64 == d && (p[q / 4] = String.fromCharCode(j));
                d = p.join("");
        ...
        d.eventdispatcher = function(d, f) {
            ...
            this.addEventListener = function(e, b, c) {
                try {
                    a.exists(h[e]) || (h[e] = []), "string" == a.typeOf(b) && (b = new Function("return " + b)()), 
                    h[e].push({
                        listener: b,
                        count: c
                    });
        ...
        d.plugin = function(f) {
            ...
            a.extend(this, l);
            this.load = function() {
                if (b == a.loaderstatus.NEW) if (0 < f.lastIndexOf(".swf")) c = f, b = a.loaderstatus.COMPLETE, 
                l.sendEvent(k.COMPLETE); else if (a.getPluginPathType(f) == a.pluginPathType.CDN) b = a.loaderstatus.COMPLETE, 
                l.sendEvent(k.COMPLETE); else {
        ...
        var a = d.utils, k = d.events, f = a.foreach;
        d.plugins.pluginloader = function(h, e) {
            ...
            function b() {
                l || j();
                if (!n && !m) {
                    var b = 0, c = h.getPlugins();
                    a.foreach(l, function(e) {
                        e = a.getPluginName(e);
                        var f = c[e];
                        e = f.getJS();
                        var g = f.getTarget(), f = f.getStatus();
                        if (f == a.loaderstatus.LOADING || f == a.loaderstatus.NEW) b++; else if (e && (!g || parseFloat(g) > parseFloat(d.version))) m = !0, 
                        p = "Incompatible player version", j();
                    });
                    0 == b && j();
                }
            }
            ...
            this.setupPlugins = function(b, c, e) {
                var g = {
                    length: 0,
                    plugins: {}
                }, j = 0, d = {}, n = h.getPlugins();
                f(c.plugins, function(f, h) {
                    var k = a.getPluginName(f), l = n[k], m = l.getFlashPath(), q = l.getJS(), p = l.getURL();
                    m && (g.plugins[m] = a.extend({}, h), g.plugins[m].pluginmode = l.getPluginmode(), 
                    g.length++);
                    try {
        ...
        (a.jwparser = function() {}).parseEntry = function(k, f) {
            ...
            if (h.length) {
                f.sources = [];
                for (b = 0; b < h.length; b++) 0 < h[b].file.length && (h[b]["default"] = "true" == h[b]["default"] ? !0 : !1, 
                h[b].label.length || delete h[b].label, f.sources.push(h[b]));
            }
            if (e.length) {
                f.tracks = [];
                for (b = 0; b < e.length; b++) 0 < e[b].file.length && (e[b]["default"] = "true" == e[b]["default"] ? !0 : !1, 
                e[b].kind = !e[b].kind.length ? "captions" : e[b].kind, e[b].label.length || delete e[b].label, 
                f.tracks.push(e[b]));
            }
            return f;
        };
    }(jwplayer), function(d) {
        var a = jwplayer.utils, k = a.xmlAttribute, f = d.localName, h = d.textContent, e = d.numChildren, j = d.mediaparser = function() {};
        ...
        var k = jwplayer.utils, f = d.textContent, h = d.getChildNode, e = d.numChildren, j = d.localName;
        d.rssparser = {};
        ...
        d.playlist = function(a) {
            var k = [];
            if ("array" == d.utils.typeOf(a)) for (var f = 0; f < a.length; f++) k.push(new d.playlist.item(a[f])); else k.push(new d.playlist.item(a));
            return k;
        };
    }(jwplayer), function(d) {
        var a = d.item = function(k) {
            var f = jwplayer.utils, h = f.extend({}, a.defaults, k);
        ...
        d.loader = function() {
            function a(e) {
                try {
                    ...
                    if ("rss" != h.localName(e)) b("Not a valid RSS feed"); else {
        ...
        var a = d.utils, k = d.events, f = !0, h = !1, e = document, j = d.embed = function(b) {
            ...
            function n() {
                ...
                if ("array" == a.typeOf(r.playlist) && 2 > r.playlist.length && (0 == r.playlist.length || !r.playlist[0].sources || 0 == r.playlist[0].sources.length)) p(); else if (!z) if ("string" == a.typeOf(r.playlist)) {
                    ...
                    for (g = 0; g < r.modes.length; g++) if (r.modes[g].type && j[r.modes[g].type]) {
                        ...
                        if (w.supportsConfig()) return w.addEventListener(k.ERROR, m), w.embed(), c(b, u.events), 
                        b;
                    }
                    if (r.fallback) {
                    ...
                    } else x = "No suitable players found and fallback disabled", q(x, h), a.log(x), 
        ...
        function a(a) {
            if (a.playlist) for (var d = 0; d < a.playlist.length; d++) a.playlist[d] = new h(a.playlist[d]); else {
                var b = {};
                f.foreach(h.defaults, function(c) {
                    k(a, b, c);
                });
                b.sources || (a.levels ? (b.sources = a.levels, delete a.levels) : (d = {}, k(a, d, "file"), 
                k(a, d, "type"), b.sources = d.file ? [ d ] : []));
                a.playlist = [ new h(b) ];
            }
        }
        function k(a, d, b) {
        ...
        (d.embed.config = function(e) {
            ...
            e.listbar && (e.playlistsize = e.listbar.size, e.playlistposition = e.listbar.position, 
            e.playlistlayout = e.listbar.layout);
            e.flashplayer && (b.src = e.flashplayer);
            e.html5player && (j.src = e.html5player);
            a(e);
            b = e.aspectratio;
            if ("string" != typeof b || !f.exists(b)) j = 0; else {
                var c = b.indexOf(":");
                -1 == c ? j = 0 : (j = parseFloat(b.substr(0, c)), b = parseFloat(b.substr(c + 1)), 
                j = 0 >= j || 0 >= b ? 0 : 100 * (b / j) + "%");
            }
        ...
        var a = d.utils, k = document;
        d.embed.download = function(d, h, e) {
            function j(b, c) {
                for (var e = k.querySelectorAll(b), d = 0; d < e.length; d++) a.foreach(c, function(a, b) {
                    e[d].style[a] = b;
                });
            }
            function b(a, b, c) {
            ...
            if (c && c.length) {
                ...
                for (c = 0; c < p.length; c++) {
                    var u = p[c], v = u.type ? u.type : a.extensionmap.extType(a.extension(u.file));
                    u.file && a.foreach(t, function(b) {
                        v == t[b] ? (l = u.file, g = r.image) : a.isYouTube(u.file) && (q = u.file);
                    });
                }
                l ? (p = l, e = g, d && (c = b("a", "display", d), b("div", "icon", c), b("div", "logo", c), 
                p && c.setAttribute("href", a.getAbsolutePath(p))), c = "#" + d.id + " .jwdownload", 
                d.style.width = "", d.style.height = "", j(c + "display", {
                ...
                })) : q ? (h = q, d = b("embed", "", d), d.src = "http://www.youtube.com/v/" + a.youTubeID(h), 
                d.type = "application/x-shockwave-flash", d.width = n, d.height = m) : e();
            }
        };
    }(jwplayer), function(d) {
        var a = d.utils, k = d.events, f = {};
        (d.embed.flash = function(e, j, b, c, n) {
            ...
            var g = new d.events.eventdispatcher(), q = a.flashVersion();
            a.extend(this, g);
            this.embed = function() {
                b.id = n.id;
                ...
                if (e.id + "_wrapper" == e.parentNode.id) d = document.getElementById(e.id + "_wrapper"); else {
                ...
                v.base = h + "/";
                f[e.id] = v;
                a.isIE() ? (h = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width="100%" height="100%"id="' + e.id + '" name="' + e.id + '" tabindex=0"">', 
                h += '<param name="movie" value="' + j.src + '">', h += '<param name="allowfullscreen" value="true"><param name="allowscriptaccess" value="always">', 
                h += '<param name="seamlesstabbing" value="true">', h += '<param name="wmode" value="' + d + '">', 
                h += '<param name="bgcolor" value="#000000">', h += "</object>", e.outerHTML = h, 
                d = document.getElementById(e.id)) : (h = document.createElement("object"), h.setAttribute("type", "application/x-shockwave-flash"), 
                h.setAttribute("data", j.src), h.setAttribute("width", "100%"), h.setAttribute("height", "100%"), 
                h.setAttribute("bgcolor", "#000000"), h.setAttribute("id", e.id), h.setAttribute("name", e.id), 
                h.setAttribute("tabindex", 0), m(h, "allowfullscreen", "true"), m(h, "allowscriptaccess", "always"), 
                m(h, "seamlesstabbing", "true"), m(h, "wmode", d), e.parentNode.replaceChild(h, e), 
                d = h);
        ...
        d.embed.html5 = function(h, e, j, b, c) {
            ...
            p.embed = function() {
                if (d.html5) {
                    ...
                    c.setPlayer(g, "html5");
                } else g = new a.scriptloader(e.src), g.addEventListener(f.ERROR, m), g.addEventListener(f.COMPLETE, p.embed), 
                g.load();
            };
            p.supportsConfig = function() {
                if (d.vid.canPlayType) try {
                    ...
                    for (var b = j.playlist[0].sources, c = 0; c < b.length; c++) {
                        ...
                        if (null !== navigator.userAgent.match(/BlackBerry/i) || a.isAndroid() && ("m3u" == a.extension(f) || "m3u8" == a.extension(f)) || a.isRtmp(f, h)) e = !1; else {
                            var l = k[h ? h : a.extension(f)], m;
                            if (!l || l.flash && !l.html5) m = !1; else {
                                var n = l.html5, p = d.vid;
                                if (n) try {
        ...
        var a = d.embed, k = d.utils, f = k.extend(function(f) {
            var e = k.repo(), j = k.extend({}, d.defaults), b = k.extend({}, j, f.config), c = f.config, n = b.plugins, m = b.analytics, p = e + "jwpsrv.js", l = e + "sharing.js", g = e + "related.js", q = e + "gapro.js", j = d.key ? d.key : j.key, r = new d.utils.key(j).edition(), n = n ? n : {};
            ...
            switch (r) {
              ...
              case "ads":
                ...
                n[g] = b.related), b.ga && (b.ga.client && b.ga.client.match(".js$|.swf$") && (q = b.ga.client), 
                n[q] = b.ga), c.sitecatalyst && new d.embed.sitecatalyst(f);

              case "pro":
                b.sharing && (b.sharing.client && b.sharing.client.match(".js$|.swf$") && (l = b.sharing.client), 
                n[l] = b.sharing), b.skin && (c.skin = b.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i, k.repo() + "skins/$1.xml"));
            }
            c.plugins = n;
            return new a(f);
        }, a);
        ...
        j.destroyPlayer = function(b) {
            ...
            0 <= c && (b = d.id, f = e.getElementById(b + ("flash" == d.renderingMode ? "_wrapper" : "")), 
            k.clearCss && k.clearCss("#" + b), f && ("html5" == d.renderingMode && d.destroyPlayer(), 
            d = e.createElement("div"), d.id = b, f.parentNode.replaceChild(d, f)), a.splice(c, 1));
            return null;
        };
