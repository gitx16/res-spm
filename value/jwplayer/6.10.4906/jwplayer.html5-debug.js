define("value/jwplayer/6.10.4906/jwplayer.html5-debug", [ "./jwplayer-debug" ], function(require, exports, module) {
    "use strict";
    require("./jwplayer-debug");
    (function(h) {
        h.html5 = {};
    ...
    (function(h) {
        ...
        h.bounds = function(b) {
            ...
            if (b.getBoundingClientRect) {
                ...
                var e = window.pageYOffset, g = window.pageXOffset;
    ...
    (function(h) {
        ...
        h.stretch = function(b, a, e, g, c, d) {
            ...
            switch (b.toLowerCase()) {
              ...
              default:
                f > D ? .95 < c * D / e ? (s = !0, v = "jwexactfit") : (c *= D, d *= D) : .95 < d * f / g ? (s = !0, 
                v = "jwexactfit") : (c *= f, d *= f), s && (f = 2 * Math.ceil(e / 2) / c, D = 2 * Math.ceil(g / 2) / d);
            }
            m ? (b = {
                left: "",
                right: "",
                width: "",
                height: ""
            }, s ? (e < c && (b.left = b.right = Math.ceil((e - c) / 2)), g < d && (b.top = b.bottom = Math.ceil((g - d) / 2)), 
            b.width = c, b.height = d, h.scale(a, f, D, 0, 0)) : (s = !1, h.transform(a)), h.css.style(a, b)) : a.className = a.className.replace(/\s*jw(none|exactfit|uniform|fill)/g, "") + " " + v;
            return s;
        };
    })(jwplayer.utils);
    (function(h) {
        h.dfxp = function() {
            ...
            this.parse = function(b) {
                ...
                var e = b.split("</p>"), g = b.split("</tt:p>"), c = [];
                for (b = 0; b < e.length; b++) 0 <= e[b].indexOf("<p") && (e[b] = e[b].substr(e[b].indexOf("<p") + 2).replace(/^\s+/, "").replace(/\s+$/, ""), 
                c.push(e[b]));
                for (b = 0; b < g.length; b++) 0 <= g[b].indexOf("<tt:p") && (g[b] = g[b].substr(g[b].indexOf("<tt:p") + 5).replace(/^\s+/, "").replace(/\s+$/, ""), 
                c.push(g[b]));
                e = c;
                for (b = 0; b < e.length; b++) {
                    ...
                    c = {};
                    try {
                        var d = g.indexOf('begin="'), g = g.substr(d + 7), d = g.indexOf('" end="');
    ...
    (function(h) {
        ...
        h.html5.video = function(d, f) {
            ...
            function u(a) {
                O && (A || (A = g, n()), "loadedmetadata" == a.type && (d.muted && (d.muted = c, 
                d.muted = g), v()));
            }
            function j() {
            ...
            function w(b, f) {
                ...
                W = setInterval(E, 100);
                I = 0;
                d.src !== K.file || H || J ? (L = A = c, t = f ? f : -1, d.src = K.file, d.load()) : (0 === b && (I = -1, 
                xa(b)), v(), d.play());
                G = d.currentTime;
                H && n();
            ...
            var q = k.isMSIE(), H = k.isMobile(), J = k.isSafari(), C = {
                ...
                emptied: m,
                ended: function() {
                    O && x != a.IDLE && (e(W), Z = -1, ia = g, h(b.JWPLAYER_MEDIA_BEFORECOMPLETE), O && (l(a.IDLE), 
                    ia = c, h(b.JWPLAYER_MEDIA_COMPLETE)));
                },
                error: function() {
            ...
            }, r, K, t, G, A = c, L, I = 0, P = c, x = a.IDLE, Y, W = -1, X = -1, O = c, V, Z = -1, ha = k.isAndroidNative(), ja = k.isIOS(7), Ta = [], ia = c, ya = null, Q = k.extend(this, new b.eventdispatcher(f));
            Q.load = function(a) {
                if (O) {
                    V = a.sources;
                    0 > Z && (Z = 0);
                    if (V) for (var c = k.getCookies().qualityLabel, d = 0; d < V.length; d++) if (V[d]["default"] && (Z = d), 
                    c && V[d].label == c) {
                        Z = d;
                        break;
                    }
    ...
    (function(h, k) {
        ...
        e.html5.youtube = function(a) {
            ...
            function j() {
                var c;
                if (c = !!K) c = G.parentNode, c || (P || (e(a).onReady(j), P = !0), c = null), 
                c = !!c;
                c && x && x.apply(r);
            }
            function n(b) {
            ...
            function l(a) {
                ...
                switch (a.data) {
                  case b.ENDED:
                    L != d.IDLE && (O = !0, r.sendEvent(c.JWPLAYER_MEDIA_BEFORECOMPLETE, void 0), n(d.IDLE), 
                    O = !1, r.sendEvent(c.JWPLAYER_MEDIA_COMPLETE, void 0));
                    break;
            ...
            var r = g.extend(this, new c.eventdispatcher("html5.youtube")), K = h.YT, t = null, G = k.createElement("div"), A, L = d.IDLE, I = -1, P = !1, x = null, Y = null, W = -1, X = -1, O = !1, V = D || m, Z = !0;
    ...
    (function(h) {
        ...
        h.html5.adskipbutton = function(c, d, f, h) {
            ...
            function n(a, c, b, d, e, f, j, h, x) {
                ...
                a.closePath();
                h && (a.strokeStyle = "white", a.globalAlpha = x ? 1 : .25, a.stroke());
                j && (a.fillStyle = "#000000", a.globalAlpha = .5, a.fill());
            }
            function B(a, c) {
            ...
            C.updateSkipTime = function(a, c) {
                ...
                }), 0 < w - a ? (m(a), l && (l = !1, y.style.cursor = "default")) : l || (l || (l = !0, 
                y.style.cursor = "pointer"), J ? j() : u()));
            };
    ...
    (function(h) {
        ...
        k.captions = function(c, k) {
            ...
            function j() {
                ...
                0 !== a && 0 !== c && C.resize(c, Math.round(.94 * a));
            }
            function n(a, c) {
                b.ajax(a, function(a) {
            ...
            function l(c) {
                0 < c ? (K = c - 1, L = c | 0, K >= t.length || (t[K].data ? C.populate(t[K].data) : G == t.length ? (v("file not loaded: " + t[K].file), 
                0 !== L && E(a.JWPLAYER_CAPTIONS_CHANGED, t, 0), L = 0) : A = c, p(!1))) : (L = 0, 
                p(!1));
            }
            function E(a, c, b) {
                P.sendEvent(a, {
            ...
            this.setCurrentCaptions = function(c) {
                0 <= c && L != c && c <= t.length && (l(c), c = z(), b.saveCookie("captionLabel", c[L].label), 
            ...
            c.jwAddEventListener(a.JWPLAYER_PLAYLIST_ITEM, function() {
                ...
                C.update(0);
                G = 0;
                for (var e = c.jwGetPlaylist()[c.jwGetPlaylistIndex()].tracks, f = [], j = 0, h = "", g = 0, h = "", j = 0; j < e.length; j++) h = e[j].kind.toLowerCase(), 
    ...
    (function(h) {
        ...
        h.html5.captions.renderer = function(a, e) {
            ...
            function c() {
                if ("visible" === n) {
                    var c = m.clientWidth, d = Math.pow(c / 400, .6), e = a.fontSize * d;
                    b(v, {
                        maxWidth: c + "px",
            ...
            var y = a.fontOpacity, p = a.windowOpacity, w = a.edgeStyle, l = a.backgroundColor, E = {
                display: "inline-block"
            }, z = {
    ...
    (function(h) {
        ...
        var b = h.html5, a = h.utils, e = h.events, g = e.state, c = a.css, d = a.transitionStyle, f = a.isMobile(), D = a.isAndroid(4, !0), m = "button", s = "text", v = "slider", u = "none", j = "100%", n = !1, B = !0, y = null, p = "", w = {
            display: u
        }, l = {
            display: "block"
        }, E = {
            display: p
        }, z = "array", q = window, H = document;
        b.controlbar = function(d, C) {
            ...
            function K(b) {
                c.block(aa);
                var e = b.duration == Number.POSITIVE_INFINITY, j = 0 === b.duration && 0 !== b.position && a.isSafari() && !f;
                e || j ? (U.setText(d.jwGetPlaylist()[d.jwGetPlaylistIndex()].title || "Live broadcast"), 
                ja(!1)) : (F.elapsed && (e = a.timeFormat(b.position), F.elapsed.innerHTML = e), 
                F.duration && (e = a.timeFormat(b.duration), F.duration.innerHTML = e), 0 < b.duration ? Ga(b.position / b.duration) : Ga(0), 
                ra = b.duration, sa = b.position, ma || U.setText());
            }
            function t() {
                var a = d.jwGetMute();
            ...
            function L(a) {
                fa && (Ia = a.track | 0, F.cc && (F.cc.querySelector("button").className = 2 === fa.length && 0 === Ia ? "off" : p), 
            ...
            function ja(a) {
                R && F.alt && (void 0 === a && (a = R.parentNode && 320 <= R.parentNode.clientWidth), 
            ...
            function ia(c, b) {
                a.exists(b) || (b = !mb[c]);
                F[c] && (F[c].className = "jw" + c + (b ? " jwtoggle jwtoggling" : " jwtoggling"), 
                setTimeout(function() {
            ...
            function ya() {
                ga && 2 < ga.length && (nb && (clearTimeout(nb), nb = void 0), c.block(aa), na.show(), 
                Ka("hd", na), ha("hd"));
            }
            function Q() {
                fa && 2 < fa.length && (ob && (clearTimeout(ob), ob = void 0), c.block(aa), oa.show(), 
                Ka("cc", oa), ha("cc"));
            }
            function Sa(a) {
            ...
            function kb(c) {
                if (za) {
                    ...
                    100 < b && (b = 100);
                    c.type == a.touchEvents.DRAG_END ? (d.jwSeekDrag(n), F.timeRail.className = "jwrail", 
                    cb(), db.time(b), Xa()) : (Ga(b), 500 < sa - pb && (pb = sa, db.time(b)));
            ...
            function wb(a) {
                return function(c) {
                    c.button || (F[a + "Rail"].className = "jwrail", "time" === a ? d.jwGetState() != g.IDLE && (d.jwSeekDrag(B), 
                    Ea(a)) : Ea(a));
                };
            }
            function Qa(c) {
                if (za && !c.button) {
                    ...
                    "mouseup" == c.type ? ("time" == b && d.jwSeekDrag(n), F[b + "Rail"].className = "jwrail", 
                    cb(), db[b.replace("H", p)](e)) : ("time" == za ? Ga(e) : Ua(e), 500 < sa - pb && (pb = sa, 
                    db[za.replace("H", p)](e)));
                    return !1;
                }
            }
            ...
            function N(c) {
                La = a.bounds(R);
                if ((Ya = a.bounds(eb)) && 0 !== Ya.width) c = c.pageX ? c.pageX - Ya.left : c.x, 
                pa.positionX(Math.round(c)), xb(ra * c / Ya.width);
            }
            function Aa() {
                a.foreach(fb, function(a, b) {
                    var d = {};
                    "%" === b.position.toString().slice(-1) ? d.left = b.position : 0 < ra ? (d.left = (100 * b.position / ra).toFixed(2) + "%", 
                    d.display = null) : (d.left = 0, d.display = "none");
                    c.style(b.element, d);
                });
            }
            function qa() {
                ...
                if (f) {
                    ...
                    new a.touch(b).addEventListener(a.touchEvents.TAP, function() {
                        ...
                        "cc" == j ? (2 == fa.length && (a = Fa), gb ? (M(), c.hide()) : (gb = setTimeout(function() {
                            c.hide();
                            gb = void 0;
                        }, 4e3), a()), U.sendEvent(e.JWPLAYER_USER_ACTION)) : "hd" == j && (2 == ga.length && (a = Ca), 
                        hb ? (S(), c.hide()) : (hb = setTimeout(function() {
                            c.hide();
                            hb = void 0;
            ...
            function $a(d) {
                ...
                if (da[d]) {
                    ...
                    if (e && 0 < e.elements.length) for (var t = 0; t < e.elements.length; t++) {
                            ...
                            switch (g.type) {
                              case s:
                                ...
                                if (q.src) {
                                    var r = X();
                                    r.id = aa + "_" + g;
                                    "elapsed" == g || "duration" == g ? (r.className = "jwtext jw" + g + " jwhidden", 
                                    Va.push(r)) : r.className = "jwtext jw" + g;
                              ...
                              case v:
                                ...
                                if (f && 0 === l.indexOf("volume")) B = void 0; else {
                                    ...
                                    for (var J = 0; J < Y.length; J++) {
                                        var L = "time" == K ? "Slider" : p, ja = K + L + Y[J], M = O(ja, y, !A, 0 === K.indexOf("volume"), A), N = O(ja + "Cap" + E, y, n, n, A), Q = O(ja + "Cap" + C, y, n, n, A), R = T(ja + "Cap" + E), U = T(ja + "Cap" + C);
                                        if (M) {
                                            var S = X();
                                            ...
                                            2 == J && (I = S);
                                            2 == J && !A ? (M = X(), M.className = "jwprogressOverflow", M.appendChild(S), F[ja] = M, 
                                            P.appendChild(M)) : (F[ja] = S, P.appendChild(S));
                                        }
                                    }
                                    ...
                                    f ? (A = new a.touch(P), A.addEventListener(a.touchEvents.DRAG_START, vb), A.addEventListener(a.touchEvents.DRAG, kb), 
                                    A.addEventListener(a.touchEvents.DRAG_END, kb), A.addEventListener(a.touchEvents.TAP, Oa)) : (I = K, 
                                    "volume" == I && !A && (I += "H"), P.addEventListener("mousedown", wb(I), n));
                                    ...
                                    F[l] = g;
                                    g.vertical = r;
                                    "time" == l ? (pa = new b.overlay(aa + "_timetooltip", $), ib = new b.thumbs(aa + "_thumb"), 
                                    jb = H.createElement("div"), jb.className = "jwoverlaytext", sb = H.createElement("div"), 
                                    B = ib.element(), sb.appendChild(B), sb.appendChild(jb), pa.setContents(sb), eb = K, 
                                    xb(0), B = pa.element(), K.appendChild(B), F.timeSliderRail || c.style(F.time, w), 
                                    F.timeSliderThumb && c.style(F.timeSliderThumb, {
                                        "margin-left": T("timeSliderThumb").width / -2
                                    }), B = T("timeSliderCue"), q = {
                                        "z-index": 1
                                    }, B && B.src ? (O("timeSliderCue"), q["margin-left"] = B.width / -2) : q.display = u, 
                                    c(W(".jwtimeSliderCue"), q), va(0), Ga(0), Ga(0), va(0)) : 0 === l.indexOf("volume") && (l = g, 
                                    x = "volume" + (r ? p : "H"), z = r ? "vertical" : "horizontal", c(W(".jw" + x + ".jw" + z), {
                        ...
                        g && ("volume" == e.elements[t].name && g.vertical ? (wa = new b.overlay(aa + "_volumeOverlay", $), 
                        wa.setContents(g)) : h.appendChild(g));
                    }
                }
            }
            function ba() {
            ...
            function Za() {
                !tb && 1 < d.jwGetPlaylist().length && (!H.querySelector("#" + d.id + " .jwplaylist") || d.jwGetFullscreen()) ? (c.style(F.next, E), 
                c.style(F.prev, E)) : (c.style(F.next, w), c.style(F.prev, w));
            }
            function Ka(c, b) {
                La || (La = a.bounds(R));
                b.constrainX(La, !0);
            ...
            function Na(a, b) {
                if (F[a]) {
                    ...
                    g && (j = {}, d ? (j.height = f, j.bottom = 0) : j.width = f, "volume" !== a && (j.opacity = 0 < b || za ? 1 : 0), 
                    c.style(g, j));
            ...
            U.adMode = function(a) {
                if (void 0 !== a && a !== tb) {
                    ...
                    if (a) {
                        ...
                        -1 < d && b.splice(d, 1);
                    } else b = Va, d = F.elapsed, -1 === b.indexOf(d) && b.push(d), b = Va, d = F.duration, 
                ...
                a.foreach(b, function(a, b) {
                    if (b.text) {
                        ...
                        if (/^[\d\.]+%?$/.test(c.toString())) {
                            var e = O("timeSliderCue"), f = F.timeSliderRail, j = {
                                position: c,
                                text: d,
                                element: e
                            };
            ...
            F.hd && (na = new b.menu("hd", aa + "_hd", $, Sa), f ? Ba(na, F.hd, ya, "hd") : Ra(na, F.hd, ya, qb), 
            lb.hd = na);
            F.cc && (oa = new b.menu("cc", aa + "_cc", $, xa), f ? Ba(oa, F.cc, Q, "cc") : Ra(oa, F.cc, Q, qa), 
            lb.cc = oa);
            F.mute && F.volume && F.volume.vertical && (wa = new b.overlay(aa + "_volumeoverlay", $), 
            wa.setContents(F.volume), Ra(wa, F.mute, Ta), lb.volume = wa);
            c.style(Ma.right, {
                right: T("capRight").width
            });
            Cb && R.appendChild(Cb);
            ...
            d.jwAddEventListener(e.JWPLAYER_PLAYLIST_ITEM, function(b) {
                if (!ma) {
                    ...
                    fb.length = 0;
                    if (a.typeOf(b) == z && !f) for (var j = 0; j < b.length; j++) if (!c && b[j].file && b[j].kind && "thumbnails" == b[j].kind.toLowerCase() && (ib.load(b[j].file), 
                    c = B), b[j].file && b[j].kind && "chapters" == b[j].kind.toLowerCase()) {
                        var g = b[j].file;
    ...
    (function(h) {
        ...
        h.html5.controller = function(d, f) {
            ...
            function y() {
                d.state == a.IDLE && (H ? H = c : (q = y, d.repeat ? B() : d.item == d.playlist.length - 1 ? (E = 0, 
    ...
    (function(h) {
        ...
        k.display = function(h, v) {
            function u(d) {
                if (V && (h.jwGetControls() || h.jwGetState() == e.PLAYING)) V(d); else if ((!c || !h.jwGetControls()) && O.sendEvent(a.JWPLAYER_DISPLAY_CLICK), 
                h.jwGetControls()) {
                    var j = new Date().getTime();
                    Z && 500 > j - Z ? (h.jwSetFullscreen(), Z = void 0) : Z = new Date().getTime();
                    var f = b.bounds(z.parentNode.querySelector(".jwcontrolbar")), g = b.bounds(z), j = f.left - 10 - g.left, B = f.left + 30 - g.left, t = g.bottom - 40, r = g.bottom, q = f.right - 30 - g.left, f = f.right + 10 - g.left;
            ...
            function j(a, b) {
                X.showicons && (a || b ? (x.setRotation("buffer" == a ? parseInt(X.bufferrotation, 10) : 0, parseInt(X.bufferinterval, 10)), 
                x.setIcon(a), x.setText(b)) : x.hide());
            }
            function n(a) {
                C != a ? (C && E(f, m), (C = a) ? (a = new Image(), a.addEventListener("load", p, m), 
                a.src = C) : (g("#" + z.id + " " + f, {
                    "background-image": ""
            ...
            function y(a) {
                ...
                if (a != W) switch (W = a, x && x.setRotation(0), a) {
                  case e.IDLE:
                    !A && !L && (C && !t && E(f, D), a = !0, h._model && !1 === h._model.config.displaytitle && (a = !1), 
                    j("play", J && a ? J.title : ""));
                    break;
    ...
    (function(h) {
        ...
        h.html5.displayicon = function(c, d, f, D) {
            ...
            function s(a, c, e, j, f) {
                ...
                g.src ? (j = k.extend({}, j), 0 < c.indexOf("Icon") && (C = g.width | 0), j.width = g.width, 
                j["background-image"] = "url(" + g.src + ")", j["background-size"] = g.width + "px " + g.height + "px", 
                j["float"] = "none", f = k.extend({}, f), g.overSrc && (f["background-image"] = "url(" + g.overSrc + ")"), 
                k.isMobile() || b("#" + d.id + " .jwdisplay:hover " + e, f), b.style(y, {
                    display: "table"
                })) : b.style(y, {
                    display: "none"
                });
            ...
            function j() {
                ...
                var a = "px " + g, c = Math.ceil(Math.max(J.width, k.bounds(y).width - l.width - w.width)), a = {
            ...
            b("#" + c, I);
            k.isMobile() || (p.overSrc && (I["background-image"] = "url(" + w.overSrc + "), url(" + p.overSrc + "), url(" + l.overSrc + ")"), 
            b(".jw-tab-focus #" + c + ", #" + d.id + " .jwdisplay:hover " + ("#" + c), I));
            z = m("jwtext", y, f, D);
            q = m("jwicon", y);
        ...
        k.instream = function(c, d, f, h) {
            ...
            x.jwInstreamDestroy = function(c) {
                if (I) {
                    ...
                    A && (J && J.parentElement && J.parentElement.removeEventListener("click", A.clickHandler), 
            ...
            x.jwStop = function() {
                "true" == q.controlbarstoppable.toString().toLowerCase() && (c.jwInstreamDestroy(!1, x), 
                c.jwStop());
            };
            x.jwSeek = function(a) {
            ...
            d.setItem = function(c) {
                ...
                if (e || c !== d.item) {
                    ...
                    if (d.playlist.length) {
                        var j = e.sources[0];
                        if ("youtube" === j.type || b.isYouTube(j.file)) c = D.youtube, c !== f && (c && c.destroy(), 
                        c = D.youtube = new k.youtube(d.id));
                    }
                    d.setVideo(c);
                    c.init && c.init(e);
                }
    ...
    (function(h) {
        ...
        h.html5.overlay = function(a, h, v) {
            ...
            function y(a, j) {
                ...
                j && (h[j] = f[j], h[a] = 0, q[a] = f[a], q[j] = 0, b(u("jw" + a), h), b(u("jw" + j), q), 
                C[a] = f[a], C[j] = f[j]);
            }
    ...
    (function(h) {
        ...
        h.playlistcomponent = function(d, f) {
            ...
            q.itemImage ? (C = (z - q.itemImage.height) / 2 + "px ", r = q.itemImage.width, 
            K = q.itemImage.height) : (r = 4 * z / 3, K = z);
            ...
            v.jwAddEventListener(b.JWPLAYER_PLAYLIST_LOADED, function() {
                ...
                if (y = c) {
                    ...
                    for (b = 0; b < y.length; b++) {
                        ...
                        d.id = p.id + "_item_" + f;
                        0 < f ? (j = m("div", "jwplaylistdivider"), d.appendChild(j)) : (f = q.divider ? q.divider.height : 0, 
                        d.style.height = z - f + "px", d.style["background-size"] = "100% " + (z - f) + "px");
                        ...
                        f.appendChild(j);
                        c.description && !H && (j = m("span", "jwdescription"), j.innerHTML = c.description, 
                        f.appendChild(j));
                        d.appendChild(f);
                        c = d;
    ...
    (function(h) {
        ...
        h.playlistslider = function(d, f, h, k) {
            ...
            function j(a) {
                if (t) return a = a ? a : c.event, V(C - (a.detail ? -1 * a.detail : a.wheelDelta / 40) / 10), 
                a.stopPropagation && a.stopPropagation(), a.preventDefault ? a.preventDefault() : a.returnValue = !1, 
                a.cancelBubble = !0, a.cancel = !0, !1;
            }
            function n(a) {
                0 == a.button && (J = !0);
            ...
            function y(a) {
                if (J || "click" == a.type) {
                    var c = b.bounds(q), d = H.clientHeight / 2;
                    V((a.pageY - c.top - d) / (c.height - d - d));
                }
            }
            function p(a) {
                return function(b) {
                    0 < b.button || (V(C + .05 * a), r = setTimeout(function() {
    ...
    (function(h) {
        ...
        h.skinloader = function(e, g, c) {
            ...
            function D(a) {
                ...
                if (0 === a.length) j(u); else for (c = 0; c < a.length; c++) {
            ...
            function s(a, b) {
                ...
                c.onload = function() {
                    ...
                    e ? (e.height = Math.round(c.height / E * l), e.width = Math.round(c.width / E * l), 
                    e.src = c.src, e.ready = !0, m()) : k.log("Loaded an image for a missing element: " + a + "." + d);
                };
                c.onerror = function() {
                    w = !0;
                    m();
            ...
            var u = {}, j = g, n = c, B = !0, y, p = e, w = !1, l = (jwplayer.utils.isMobile(), 
            1), E = 1;
    ...
    (function(h) {
        ...
        h.html5.thumbs = function(e) {
            ...
            this.load = function(b) {
                ...
                s && (s.onload = null, s.onreadystatechange = null, s.onerror = null, s.abort && s.abort(), 
                s = null);
                j && (j.onload = null);
                b ? (m = b.split("?")[0].split("/").slice(0, -1).join("/"), s = k.ajax(b, g, c, !0)) : (D = v = j = null, 
                u = {});
            };
            this.element = function() {
                return f;
        ...
        b.view = function(w, l) {
            ...
            function C() {
                ...
                if (s.body.contains(N)) {
                    if (b && c && (b !== Za || c !== Ka)) Za = b, Ka = c, S && S.redraw(), clearTimeout(sa), 
                    sa = setTimeout(Z, 50), ka.sendEvent(e.JWPLAYER_RESIZE, {
                        width: b,
                        height: c
                    });
            ...
            function O(b, d, e) {
                var f = N.className, g, h, k = w.id + "_view";
                c.block(k);
                if (e = !!e) f = f.replace(/\s*aspectMode/, ""), N.className !== f && (N.className = f), 
                c.style(N, {
                    display: p
                }, e);
                ...
                S && S.redraw();
                M && M.redraw(j);
                $ && ($.offset(M && 0 <= $.position().indexOf("bottom") ? M.height() + M.margin() : 0), 
                setTimeout(function() {
                ...
                if (la && g && ("right" == h || "bottom" == h)) la.redraw(), f = {
                    display: p
                }, e = {}, f[h] = 0, e[h] = g, "right" == h ? f.width = g : f.height = g, c.style(Ra, f), 
                c.style(Aa, e);
                Z(b, d);
                c.unblock(k);
            }
            function V(a) {
                ...
                M && (da ? (M.audioMode(j), Da(), S.hidePreview(j), S && S.hide(), Ea(n)) : (M.audioMode(n), 
                Qa(w.jwGetState())));
                $ && da && xa();
            ...
            function ha(a) {
                if (a.target === N || N.contains(a.target)) void 0 !== a.jwstate ? a = a.jwstate : Ia ? (a = s.currentFullScreenElement || s.webkitCurrentFullScreenElement || s.mozFullScreenElement || s.msFullscreenElement, 
                a = !!(a && a.id === w.id)) : a = l.getVideo().getFullScreen(), Ia ? ja(N, a) : Ta(a);
            }
            function ja(b, d) {
                ...
                if (l.getVideo().isCaster) S && (S.show(), S.hidePreview(n)), c.style(ba, {
                    ...
                    switch (a) {
                      case g.PLAYING:
                        ...
                        (T ? Ga : l).getVideo().audioMode() ? (Ea(n), S.hidePreview(da), S.setHiding(j), 
                        M && (Da(), M.hideFullscreen(j)), Q()) : (Ea(j), Z(), S.hidePreview(j), M && M.hideFullscreen(!l.getVideo().supportsFullscreen()));
                        break;
            ...
            var N, Aa, qa, qb, Ra, Ba = -1, $a = f ? 4e3 : 2e3, ba, Za, Ka, va, Na, Ua, Ga, T = n, M, S, ca, ea, $, rb = a.extend({}, l.componentConfig("logo")), ta, la, da, F = n, Ja = n, R = null, aa, ra, sa = -1, ga = n, Pa, fa, Ia = !1, Ha = !1, ka = a.extend(this, new e.eventdispatcher());
            this.getCurrentCaptions = function() {
            ...
            this.setup = function(d) {
                if (!F) {
                    ...
                    qb = G("span", "jwaspect");
                    d = l.height;
                    var q = l.componentConfig("controlbar"), B = l.componentConfig("display");
                    V(d);
                    ...
                    l.playlistsize && l.playlistposition && l.playlistposition != y && (la = new b.playlistcomponent(w, {}), 
                    Ra.appendChild(la.element()));
                    ...
                    w.jwAddEventListener(e.JWPLAYER_CAST_SESSION, function(a) {
                        ...
                        a.active ? (c.style(ta.element(), {
                            display: "none"
                        }), ka.forceControls(j), ca.setState("connecting").setName(a.deviceName).show(), 
                        w.jwAddEventListener(e.JWPLAYER_PLAYER_STATE, ca.statusDelegate), w.jwAddEventListener(e.JWPLAYER_CAST_AD_CHANGED, W)) : (w.jwRemoveEventListener(e.JWPLAYER_PLAYER_STATE, ca.statusDelegate), 
                        w.jwRemoveEventListener(e.JWPLAYER_CAST_AD_CHANGED, W), ca.hide(), M.adMode() && X(), 
                        c.style(ta.element(), {
                            display: null
                        }), Oa({
                            newstate: w.jwGetState()
                    ...
                    f || (qa.addEventListener("mouseout", t, n), qa.addEventListener("mousemove", L, n), 
                    a.isMSIE() && (ba.addEventListener("mousemove", L, n), ba.addEventListener("click", S.clickHandler)));
                    r(M);
                    r(ea);
                    r($);
                    c("#" + N.id + "." + v + " .jwaspect", {
            ...
            this.destroy = function() {
                ...
                ra && ra.destroy();
                ca && (w.jwRemoveEventListener(e.JWPLAYER_PLAYER_STATE, ca.statusDelegate), ca.destroy(), 
                ca = null);
    ...
    (function(h, k) {
        ...
        d.castDisplay = function(j) {
            ...
            v || (m(".jwplayer .jwcast-display", {
                ...
                opacity: 1
            }), c.cssKeyframes("spin", "from {transform: rotate(0deg);} to {transform: rotate(360deg);}"), 
            ...
            this.setCompanions = function(b) {
                ...
                for (d = b.length; d--; ) if (c = b[d], c.width && c.height && c.source) switch (c.type) {
                  ...
                  default:
                    e = Math.abs(c.width / c.height - u), e < f && (f = e, .75 > e && (h = c));
                }
                (b = h) ? (null === L && (L = a("div", "companion"), g(l, L)), b.width / b.height > u ? (c = 316, 
                d = b.height * c / b.width) : (d = 176, c = b.width * d / b.height), m.style(L, {
            ...
            this.adChanged = function(b) {
                if (b.complete) A && A.reset(-1), G = null; else {
                    ...
                    c !== G && (m(K + " .jwpreview", {
                        opacity: 0
                    }), b.companions ? this.setCompanions(b.companions) : p(), b.clickthrough ? null === I && (I = a("div", "click-label"), 
                    I.innerText = "Click here to learn more >", g(l, I)) : y(), G = c, this.setState(b.newstate));
                }
            };
    ...
    (function(h) {
        ...
        k.player = function(a) {
            ...
            var e;
            e = a._model.edition();
            if ("enterprise" === e || "ads" === e) e = new h.cast.controller(a, a._model), a.jwStartCasting = e.startCasting, 
    ...
    (function(h) {
        ...
        h.rightclick = function(a, e) {
            if ("free" == a.edition()) e.aboutlink = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + h.version + "&m=h&e=f", 
            delete e.abouttext; else {
                if (!e.aboutlink) {
                    var g = "http://www.longtailvideo.com/jwpabout/?a=r&v=" + h.version + "&m=h&e=", c = a.edition();
                    e.aboutlink = g + ("pro" == c ? "p" : "premium" == c ? "r" : "enterprise" == c ? "e" : "ads" == c ? "a" : "f");
                }
                e.abouttext ? e.abouttext += " ..." : (g = a.edition(), g = g.charAt(0).toUpperCase() + g.substr(1), 
                e.abouttext = "About JW Player " + h.version + " (" + g + " edition)");
            }
            k(this, new b(a, e));
        };
    })(jwplayer.html5);
...
define("value/jwplayer/6.10.4906/jwplayer-debug", [], function(require, exports, module) {
    "undefined" == typeof jwplayer && (jwplayer = function(h) {
        if (jwplayer.api) return jwplayer.api.selectPlayer(h);
    }, jwplayer.version = "6.10.4906", jwplayer.vid = document.createElement("video"), 
    ...
    function(h) {
        ...
        e.getAbsolutePath = function(f, a) {
            ...
            if (e.exists(f)) {
                ...
                0 === f.indexOf("/") ? b = f.split("/") : (b = a.split("?")[0], b = b.substring(k.length + m.length + 1, b.lastIndexOf("/")), 
        ...
        e.isAndroid = function(f, b) {
            return b && a(/chrome\/[123456789]/i) && !a(/chrome\/18/) ? !1 : f ? (e.isInt(f) && !/\./.test(f) && (f = "" + f + "."), 
            a(RegExp("Android\\s*" + f, "i"))) : a(/Android/i);
        };
        e.isMobile = function() {
            return e.isIOS() || e.isAndroid();
        };
        e.saveCookie = function(f, a) {
            j.cookie = "jwplayer." + f + "=" + a + "; path=/";
        };
        ...
        e.translateEventResponse = function(f, a) {
            var k = e.extend({}, a);
            if (f == h.events.JWPLAYER_FULLSCREEN && !k.fullscreen) k.fullscreen = "true" === k.message, 
            delete k.message; else if ("object" == typeof k.data) {
                var m = k.data;
                delete k.data;
                k = e.extend(k, m);
        ...
        e.foreach = function(f, a) {
            var k, m;
            for (k in f) "function" == e.typeOf(f.hasOwnProperty) ? f.hasOwnProperty(k) && (m = f[k], 
            a(k, m)) : (m = f[k], a(k, m));
        };
        e.isHTTPS = function() {
        ...
        e.repo = function() {
            var f = "http://res.tourerp.cn/" + h.version.split(/\W/).splice(0, 2).join("/") + "/";
            try {
        ...
        e.ajax = function(f, a, k, m) {
            ...
            if (f && 0 <= f.indexOf("://") && f.split("/")[2] != g.location.href.split("/")[2] && e.exists(g.XDomainRequest)) b = new g.XDomainRequest(), 
            b.onload = l(b, f, a, k, m), b.ontimeout = b.onprogress = function() {}, b.timeout = 5e3; else if (e.exists(g.XMLHttpRequest)) {
        ...
        e.filterPlaylist = function(a, b, k) {
            var m = [], d, c, g, j;
            for (d = 0; d < a.length; d++) if (c = e.extend({}, a[d]), c.sources = e.filterSources(c.sources, !1, k), 
            0 < c.sources.length) {
                for (g = 0; g < c.sources.length; g++) j = c.sources[g], j.label || (j.label = g.toString());
                m.push(c);
            }
            if (b && 0 === m.length) for (d = 0; d < a.length; d++) if (c = e.extend({}, a[d]), 
            c.sources = e.filterSources(c.sources, !0, k), 0 < c.sources.length) {
                for (g = 0; g < c.sources.length; g++) j = c.sources[g], j.label || (j.label = g.toString());
                m.push(c);
            }
            return m;
        ...
        e.filterSources = function(a, b, d) {
            ...
            if (a) {
                ...
                for (var g = 0; g < a.length; g++) {
                    var j = e.extend({}, a[g]), n = j.file, l = j.type;
                    n && (j.file = n = e.trim("" + n), l || (l = e.extension(n), j.type = l = e.extensionmap.extType(l)), 
                    b ? h.embed.flashCanPlay(n, l) && (m || (m = l), l == m && c.push(j)) : h.embed.html5CanPlay(n, l, d) && (m || (m = l), 
                    l == m && c.push(j)));
                }
            }
            return c;
        ...
        e.seconds = function(a) {
            a = a.replace(",", ".");
            var b = a.split(":"), d = 0;
            "s" == a.slice(-1) ? d = parseFloat(a) : "m" == a.slice(-1) ? d = 60 * parseFloat(a) : "h" == a.slice(-1) ? d = 3600 * parseFloat(a) : 1 < b.length ? (d = parseFloat(b[b.length - 1]), 
            d += 60 * parseFloat(b[b.length - 2]), 3 == b.length && (d += 3600 * parseFloat(b[b.length - 3]))) : d = parseFloat(a);
            return d;
        };
        ...
        var q = b.css = function(b, m, f) {
            ...
            f = f || !1;
            var h = !1, q, p;
            for (q in m) p = l(q, m[q], f), "" !== p ? p !== j[q] && (j[q] = p, h = !0) : void 0 !== j[q] && (delete j[q], 
            h = !0);
            if (h) {
                if (!e[b]) {
        ...
        h.touch = function(j) {
            function g(d) {
                d.type == l ? (a = !0, f = e(k.DRAG_START, d)) : d.type == c ? a && (q || (b(k.DRAG_START, d, f), 
                q = !0), b(k.DRAG, d)) : (a && (q ? b(k.DRAG_END, d) : (d.cancelBubble = !0, b(k.TAP, d))), 
                a = q = !1, f = null);
            }
            function b(a, b, c) {
                if (d[a] && (b.preventManipulation && b.preventManipulation(), b.preventDefault && b.preventDefault(), 
                b = c ? c : e(a, b))) d[a](b);
            }
            function e(a, b) {
                var d = null;
        ...
        h.key = function(c) {
            ...
            try {
                ...
                var b = c.split("/");
                (l = b[0]) ? /^(free|pro|premium|enterprise|ads)$/i.test(l) ? (j = b[1], b[2] && 0 < parseInt(b[2]) && (g = new Date(), 
                g.setTime(String(b[2])))) : l = "invalid" : l = "free";
            } catch (e) {
                l = "invalid";
            }
        };
        ...
        c.encrypt = function(g, b) {
            ...
            for (var n = c.strToLongs(j.encode(b).slice(0, 16)), a = e.length, d = e[a - 1], f = e[0], h, k = Math.floor(6 + 52 / a), m = 0; 0 < k--; ) {
                m += 2654435769;
                h = m >>> 2 & 3;
                for (var r = 0; r < a; r++) f = e[(r + 1) % a], d = (d >>> 5 ^ f << 2) + (f >>> 3 ^ d << 4) ^ (m ^ f) + (n[r & 3 ^ h] ^ d), 
                d = e[r] += d;
            }
            e = c.longsToStr(e);
            return l.encode(e);
        ...
        c.decrypt = function(g, b) {
            ...
            for (var e = c.strToLongs(l.decode(g)), h = c.strToLongs(j.encode(b).slice(0, 16)), a = e.length, d = e[a - 1], f = e[0], q, k = 2654435769 * Math.floor(6 + 52 / a); 0 != k; ) {
                q = k >>> 2 & 3;
                for (var m = a - 1; 0 <= m; m--) d = e[0 < m ? m - 1 : a - 1], d = (d >>> 5 ^ f << 2) + (f >>> 3 ^ d << 4) ^ (k ^ f) + (h[m & 3 ^ q] ^ d), 
                f = e[m] -= d;
                k -= 2654435769;
            }
            e = c.longsToStr(e);
        ...
        var l = {
            ...
            encode: function(c, b) {
                ...
                k = m.length % 3;
                if (0 < k) for (;3 > k++; ) q += "=", m += "\0";
                for (k = 0; k < m.length; k += 3) e = m.charCodeAt(k), h = m.charCodeAt(k + 1), 
                a = m.charCodeAt(k + 2), d = e << 16 | h << 8 | a, e = d >> 18 & 63, h = d >> 12 & 63, 
                a = d >> 6 & 63, d &= 63, f[k / 3] = r.charAt(e) + r.charAt(h) + r.charAt(a) + r.charAt(d);
                f = f.join("");
            ...
            decode: function(c, b) {
                ...
                k = b ? j.decode(c) : c;
                for (var r = 0; r < k.length; r += 4) e = m.indexOf(k.charAt(r)), h = m.indexOf(k.charAt(r + 1)), 
                d = m.indexOf(k.charAt(r + 2)), f = m.indexOf(k.charAt(r + 3)), a = e << 18 | h << 12 | d << 6 | f, 
                e = a >>> 16 & 255, h = a >>> 8 & 255, a &= 255, q[r / 4] = String.fromCharCode(e, h, a), 
                64 == f && (q[r / 4] = String.fromCharCode(e, h)), 64 == d && (q[r / 4] = String.fromCharCode(e));
                d = q.join("");
        ...
        h.events.eventdispatcher = function(l, j) {
            ...
            this.addEventListener = function(e, a, d) {
                try {
                    c.exists(b[e]) || (b[e] = []), "string" == c.typeOf(a) && (a = new Function("return " + a)()), 
                    b[e].push({
                        listener: a,
                        count: d || null
                    });
        ...
        var c = jwplayer.utils, l = jwplayer.events;
        h.pluginmodes = {
            FLASH: 0,
            JAVASCRIPT: 1,
            HYBRID: 2
        ...
        h.plugin = function(j) {
            ...
            c.extend(this, k);
            this.load = function() {
                if (n == c.loaderstatus.NEW) if (0 < j.lastIndexOf(".swf")) a = j, n = c.loaderstatus.COMPLETE, 
                k.sendEvent(l.COMPLETE); else if (c.getPluginPathType(j) == c.pluginPathType.CDN) n = c.loaderstatus.COMPLETE, 
                k.sendEvent(l.COMPLETE); else {
            ...
            function h() {
                ...
                if (!d && !f) {
                    ...
                    c.foreach(k, function(d) {
                        ...
                        m == c.loaderstatus.LOADING || m == c.loaderstatus.NEW ? a++ : d && !c.versionCheck(g) && (f = !0, 
                        q = "Incompatible player version", e());
                    });
                    0 === a && e();
                }
            }
        ...
        (c.jwparser = function() {}).parseEntry = function(l, j) {
            ...
            if (g.length) {
                j.sources = [];
                for (n = 0; n < g.length; n++) 0 < g[n].file.length && (g[n]["default"] = "true" == g[n]["default"] ? !0 : !1, 
                g[n].label.length || delete g[n].label, j.sources.push(g[n]));
            }
            if (b.length) {
                j.tracks = [];
                for (n = 0; n < b.length; n++) 0 < b[n].file.length && (b[n]["default"] = "true" == b[n]["default"] ? !0 : !1, 
                b[n].kind = !b[n].kind.length ? "captions" : b[n].kind, b[n].label.length || delete b[n].label, 
                j.tracks.push(b[n]));
            }
            return j;
        };
        ...
        var c = h.item = function(l) {
            ...
            for (b = 0; b < g.sources.length; b++) e = g.sources[b]["default"], g.sources[b]["default"] = e ? "true" == e.toString() : !1, 
        ...
        c.adprovider = function(j, g) {
            ...
            d.updateModel = function(d, e) {
                ...
                d.tag && f.tag && d.tag !== f.tag && (c.error("ad messages not received in order. new model:", d, "old model:", f), 
                b());
                h.utils.extend(f, d);
                a.updateModel(d, e);
            };
        ...
        j.controller = function(a, d) {
            ...
            function x(e, f) {
                ...
                if (g.reconcile) {
                    ...
                    var m = g.diff, h = K;
                    if (!m.id || !g.appid || !g.pageUrl) m.id = c().id, g.appid = J.appid, g.pageUrl = Q, 
                    K = w = null;
                    m.id === a.id && g.appid === J.appid && g.pageUrl === Q && (w || (a.jwInstreamState() && a.jwInstreamDestroy(!0), 
                    v(h), d.sendEvent(b.JWPLAYER_PLAYER_STATE, {
                        oldstate: m.oldstate,
                        newstate: m.newstate
                    })), H(g));
                    K = null;
            ...
            function v(m) {
                ...
                a.jwSetVolume = function(a) {
                    g.exists(a) && (a = Math.min(Math.max(0, a), 100) | 0, R(a) && (a = Math.max(0, Math.min(a / 100, 1)), 
            ...
            function H(c) {
                if ("state" === c.type) {
                    if (y && (c.diff.newstate || c.diff.position)) y.destroy(), y = null, d.setVideo(z), 
                    d.sendEvent(b.JWPLAYER_CAST_AD_CHANGED, {
                        done: !0
                    });
            ...
            l(J, "endscreen");
            l(J, "logo");
            if (J.appid && (!h.cast || !h.cast.receiver)) j.loader.addEventListener("availability", m), 
            j.loader.addEventListener("session", r), j.loader.initialize(J.appid);
        ...
        function l() {
            c && c.cast && c.cast.isAvailable && !a.apiConfig ? (a.apiConfig = new c.cast.ApiConfig(new c.cast.SessionRequest(m), e, n, c.cast.AutoJoinPolicy.ORIGIN_SCOPED), 
            c.cast.initialize(a.apiConfig, b, g)) : 15 > k++ && setTimeout(l, 1e3);
        }
        function j() {
        ...
        a.loader = d.extend({
            initialize: function(b) {
                ...
                }) : c && c.cast ? l() : q || (q = new d.scriptloader("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"), 
                q.addEventListener(f.ERROR, j), q.addEventListener(f.COMPLETE, l), q.load());
            }
        ...
        j.provider = function(h) {
            ...
            d.updateModel = function(a, c) {
                ...
                if ("ad" !== c) {
                    if (void 0 !== a.position || void 0 !== a.duration) void 0 !== a.position && (q.position = a.position), 
                    void 0 !== a.duration && (q.duration = a.duration), d.sendEvent(b.JWPLAYER_MEDIA_TIME, {
                        position: q.position,
                        duration: q.duration
                    });
        ...
        var j = h.utils, g = h.events, b = !0, e = !1, n = document, a = h.embed = function(d) {
            function f() {
                if (!B) if ("array" === j.typeOf(u.playlist) && 2 > u.playlist.length && (0 === u.playlist.length || !u.playlist[0].sources || 0 === u.playlist[0].sources.length)) m(); else if (!F) if ("string" === j.typeOf(u.playlist)) C = new h.playlist.loader(), 
                C.addEventListener(g.JWPLAYER_PLAYLIST_LOADED, function(a) {
                    ...
                    u.fallback ? (p = "No suitable players found and fallback enabled", D = setTimeout(function() {
                        r(p, b);
                    }, 10), j.log(p), new a.download(E, u, m)) : (p = "No suitable players found and fallback disabled", 
                    r(p, e), j.log(p), E.parentNode.replaceChild(H, E));
                }
            }
            function q(a) {
                x(A + a.message);
        ...
        function c(b) {
            if (b.playlist) for (var c = 0; c < b.playlist.length; c++) b.playlist[c] = new g(b.playlist[c]); else {
                ...
                h.sources || (b.levels ? (h.sources = b.levels, delete b.levels) : (c = {}, l(b, c, "file"), 
                l(b, c, "type"), h.sources = c.file ? [ c ] : []));
                b.playlist = [ new g(h) ];
            }
        }
        function l(b, c, g) {
        ...
        (h.embed.config = function(b) {
            ...
            if ("string" != typeof g || !j.exists(g)) e = 0; else {
                var a = g.indexOf(":");
                -1 == a ? e = 0 : (e = parseFloat(g.substr(0, a)), g = parseFloat(g.substr(a + 1)), 
                e = 0 >= e || 0 >= g ? 0 : 100 * (g / e) + "%");
            }
        ...
        h.embed.download = function(j, g, b) {
            ...
            if (a && a.length) {
                ...
                k ? (q = k, b = m, j && (a = h("a", "display", j), h("div", "icon", a), h("div", "logo", a), 
                q && a.setAttribute("href", c.getAbsolutePath(q))), a = "#" + j.id + " .jwdownload", 
                j.style.width = "", j.style.height = "", e(a + "display", {
                ...
                })) : r ? (g = r, j = h("iframe", "", j), j.src = "http://www.youtube.com/embed/" + c.youTubeID(g), 
                j.width = d, j.height = f, j.style.border = "none") : b();
            }
        };
    }(jwplayer), function(h) {
        ...
        (h.embed.flash = function(b, e, n, a, d) {
            ...
            this.embed = function() {
                ...
                var g, h, t = d.config.listbar, p = c.extend({}, n);
                ...
                p.base = h + "/";
                j[b.id] = p;
                c.isMSIE() ? (h = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width="100%" height="100%"id="' + b.id + '" name="' + b.id + '" tabindex=0"">', 
                h += '<param name="movie" value="' + e.src + '">', h += '<param name="allowfullscreen" value="true"><param name="allowscriptaccess" value="always">', 
                h += '<param name="seamlesstabbing" value="true">', h += '<param name="wmode" value="' + g + '">', 
                h += '<param name="bgcolor" value="#000000">', h += "</object>", b.outerHTML = h, 
                g = document.getElementById(b.id)) : (h = document.createElement("object"), h.setAttribute("type", "application/x-shockwave-flash"), 
                h.setAttribute("data", e.src), h.setAttribute("width", "100%"), h.setAttribute("height", "100%"), 
                h.setAttribute("bgcolor", "#000000"), h.setAttribute("id", b.id), h.setAttribute("name", b.id), 
                h.className = "jwswf", f(h, "allowfullscreen", "true"), f(h, "allowscriptaccess", "always"), 
                f(h, "seamlesstabbing", "true"), f(h, "wmode", g), b.parentNode.replaceChild(h, b), 
                g = h);
        ...
        h.embed.html5 = function(b, e, j, a, d) {
            ...
            k.embed = function() {
                if (h.html5) {
                    ...
                    d.setPlayer(c, "html5");
                } else c = new l.scriptloader(e.src), c.addEventListener(g.ERROR, q), c.addEventListener(g.COMPLETE, k.embed), 
                c.load();
            };
        ...
        h.embed = l.extend(function(g) {
            ...
            var e = l.repo(), n = l.extend({}, h.defaults), a = l.extend({}, n, g.config), d = g.config, f = a.plugins, q = a.analytics, k = e + "jwpsrv.js", m = e + "sharing.js", r = e + "related.js", x = e + "gapro.js", n = h.key ? h.key : n.key, u = new h.utils.key(n).edition(), t, f = f ? f : {};
            ...
            switch (u) {
              ...
              case "premium":
                a.related && (j.test(a.related.client) && (r = a.related.client), f[r] = a.related), 
                a.ga && (j.test(a.ga.client) && (x = a.ga.client), f[x] = a.ga);

              case "pro":
                a.sharing && (j.test(a.sharing.client) && (m = a.sharing.client), f[m] = a.sharing), 
                a.skin && (d.skin = a.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i, l.repo() + "skins/$1.xml"));
            }
            d.plugins = f;
            g.config = d;
            g = new c(g);
            ...
            p.dispatchEvent = function(a, b) {
                ...
                if (c) for (var c = c.slice(0), d = j.translateEventResponse(a, b), e = 0; e < c.length; e++) {
                    ...
                    if ("function" === typeof f) try {
                        a === g.JWPLAYER_PLAYLIST_LOADED && j.deepReplaceKeyName(d.playlist, [ "__dot__", "__spc__", "__dsh__", "__default__" ], [ ".", " ", "-", "default" ]), 
                        f.call(this, d);
                    } catch (h) {
