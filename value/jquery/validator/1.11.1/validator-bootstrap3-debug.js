define("jquery/validator/1.11.1/validator-bootstrap3-debug", [ "$-debug" ], function(require, exports, module) {
 ...
 */
    ...
    (function($) {
        $.validator.setDefaults({
            ...
            showErrors: function(errorMap, errorList) {
                $.each(errorList, function(i, o) {
                    ...
                    o.message = '<span class="icon-remove-sign"></span> ' + msg;
                });
                var $validElements = this.validElements();
                $validElements.closest(".form-group").removeClass("has-error");
                this.defaultShowErrors();
            },
        ...
        $.validator.messages = {
            ...
            range: $.validator.format("请输入{0}~{1}的数字"),
